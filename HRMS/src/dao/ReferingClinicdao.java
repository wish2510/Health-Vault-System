...
public class ReferingClinicdao {
	public void insert(ReferingClinicVO referingClinicVO)
	{
		try {
	...
	public java.util.List search(ReferingClinicVO referingClinicVO)
	{
	...
	public java.util.List search1(ReferingClinicVO referingClinicVO)
	{
		java.util.List ls1 =null;
