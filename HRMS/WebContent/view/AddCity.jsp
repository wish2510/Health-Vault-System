		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title -->
					<form id="form" action=" <%=request.getContextPath() %>/ser_city" method="post">
					<div class="form">
					...
					<input type="hidden" value="<%=request.getParameter("x") %>" name="x" />
						...
						<div class="fields">
							<div class="field">
								...
								<div class="input">
										<input type="text" class="medium" id="state" value="${sessionScope.upcnt[0].name}" name="txt_city"  type="text" placeholder="Enter Name of City">										
									</div>
								</div>								
							...
							<div class="field">
								...
								<div class="textarea textarea-editor">
									<textarea class="medium" name="txt_desc" class="editor"
										rows="5" style="height: 100px;">${sessionScope.upcnt[0].desc}</textarea>
							...
							<div class="buttons">
								<input
									...
									role="button" aria-disabled="false" type="submit" name="submit"
									value="Add" />
