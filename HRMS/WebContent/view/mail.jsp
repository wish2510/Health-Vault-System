		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title -->
					<form id="form" action=" <%=request.getContextPath() %>/MailController" method="post">
					...
					<div class="form">
						<div class="fields">
							...
							<div class="field">
								...
								<div class="input">
									<input type="text" id="input-medium" name="input.mediumto" class="medium" required/>
								</div>
							</div>
							...
							<div class="field">
								...
								<div class="input">
									<input type="text" id="input-medium" name="input.mediumsubject" class="medium" required/>
								</div>
							</div>
							...
							<div class="buttons">
								<input class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false" type="submit" name="submit" value="Send" />
