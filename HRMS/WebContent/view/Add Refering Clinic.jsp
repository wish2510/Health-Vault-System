		...
		<div id="header">
			...
			<div id="header-inner">
				...
				<ul id="quick">
					...
					<li>
						<a href="ChangePassword.jsp" title="Change Password"><span class="icon"><img src="./images/world_link.png" alt="Links" /></span><span>Change Password</span></a>
		...
		<div id="content">
			...
			<div id="left">
				<div id="menu">
					...
					<ul id="menu-products" class="opened">
						<li><a href="<%=request.getContextPath() %>/ReferingCliniccontroller">Submit Records</a></li>
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title -->
					<form id="form" action="<%=request.getContextPath() %>/ReferingCliniccontroller" method="post">
					<input type="hidden" value="insert" name="flag">
					<div class="form">
						<div class="fields">
							<div class="field">
								<div class="label">
									<label for="input-large">Clinic Name:</label>
								</div>
								<div class="input">
									<input type="text" id="autocomplete" name="input.autocompleteclinicname" value="" class="small focus autocomplete" />
								</div>
							</div>
							...
							<div class="field">
								...
								<div class="input">
									<input type="text" id="autocomplete" name="input.autocompleteemailprimary" value="" class="small focus autocomplete" placeholder="Primary"/>
									<input type="text" id="autocomplete" name="input.autocompleteemailsecondary" value="" class="small focus autocomplete" placeholder="Secondary"/>
							...
							<div class="field">
								...
								<div class="input">
									<input type="text" id="autocomplete" name="input.autocompletephonework" value="" class="small focus autocomplete" placeholder="Work"/>
									<input type="text" id="autocomplete" name="input.autocompletephonehome" value="" class="small focus autocomplete" placeholder="Home"/>
									<input type="text" id="autocomplete" name="input.autocompletephonemobile" value="" class="small focus autocomplete" placeholder="Mobile"/>
							...
							<div class="field">
								...
								<a href="AddCity.jsp?x=Add Patient.jsp" class="ui-button ui-widget ui-state-default ui-corner-all" style="font-weight: bold;">Add</a>
							</div>
								</div>
							</div>
