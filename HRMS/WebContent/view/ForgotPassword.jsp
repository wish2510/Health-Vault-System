...
%>
		<div id="login">
			<!-- login -->
			<div class="title"  style="width: 472px;">
...
<!--  		<div class="messages">
	...
	-->		
			<div class="inner"  style="width: 432px; height: 212px;">
				<form action="<%=request.getContextPath() %>/Logincontroller" method="get">
				<input type = "hidden" value="forgotpassword" name="flag" >
				<div class="form">
					<!-- fields -->
					<div class="fields">
						<div class="field">
							...
							<div class="input">
								<input type="text" id="emailaddress" name="username" size="40" value="" class="focus" />
							</div>
						</div>
