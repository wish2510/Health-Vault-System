		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title -->
					<form id="form" action=" <%=request.getContextPath() %>/ser_country" method="post">
					...
					<div class="form">
						<div class="fields">
							...
							<div class="field">
								...
								<div class="input">
									<input type="text" class="medium" id="ctry_name" value="${sessionScope.upcnt[0].name}" name="txt_name"  type="text" placeholder="Enter Name of Country">
