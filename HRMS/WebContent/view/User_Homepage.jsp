...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="header">
			...
			<!-- user -->
			<ul id="user">
				<li class="first"><a href="">Account(${sessionScope.login[0].username })</a></li>
			...
			<div id="header-inner">
				...
				<ul id="quick">
					...
					<li>
						<a href="<%=request.getContextPath() %>/ShareRecordcontroller?flag=usersharerecordsearch&idser=${ sessionScope.lis1[0][0].userid}" title="Trusted Contact"><span class="icon"><img src="./images/page_white_copy.png" alt="" /></span><span>Trusted Contacts</span></a>
				...
				<div class="box">
					...
					<div class="table">
						...
						<table style="margin-top: 12px">
							...
							<tbody>
							<c:forEach items="${sessionScope.lis}" var="row">
								<tr>

								
									<td class="selected last"><input type="checkbox" class="checkall" /></td>
									<td class="left"><a href="<%=request.getContextPath()%>/Userrecordcontroller?flag=search_user&id=${row[2].userRecordid}&id1=${row[2].userid}">${row[2].dateofRcd}</a></td>
									<td><a href="<%=request.getContextPath()%>/Userrecordcontroller?flag=search_user&id=${row[2].userRecordid}&id1=${row[2].userid}">${row[2].title}</a></td>
									<td>${row[3].clinicname}</td>
									
									<td><a href="<%=request.getContextPath() %>/Notescontroller?idn=${row[2].userRecordid}&flag=usernotesearch">Notes</a><a href=""> Print</a><a href="<%=request.getContextPath()%>/ShareRecordcontroller?rcdid=${row[2].userRecordid}&useid=${row[2].userid}&flag=user_share"> Share</a></td>					
								</tr>
							</c:forEach>
							</tbody>
						</table>
