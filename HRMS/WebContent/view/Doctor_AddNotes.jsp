		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<input type="hidden" value="doctornoteinsert" name="flag" />
					<input type="hidden" value="<%=request.getParameter("iddf")%>" name="iddd" />
					<div class="form">
						<div class="fields">
							<div class="field">
								<div class="label">
								...
								<div class="select">
									<select id="select" name="selectnotes">
							...
							<div class="field">
								...
								<div class="input">
									<input type="text" id="input-medium" name="input.mediumnote" class="medium" required/>
								</div>
							</div>
							...
							<div class="field">
								...
								<div class="textarea textarea-editor">
									<textarea id="textarea" name="textareadescription" cols="50" rows="12" class="editor"></textarea>
								</div>
							</div>
