		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<input type="hidden" value="${sessionScope.lsreg[0].userid}" name="id">
					<div class="form">
						<div class="fields">
							...
							<div class="field">
								...
								<div class="input input-file">
									<input type="text" id="autocomplete" name="input.autocompletefirstname" value="${sessionScope.lsreg[0].fstname}" class="small focus autocomplete" placeholder="First Name" required/>
									<input type="text" id="autocomplete" name="input.autocompletemiddlename" value="${sessionScope.lsreg[0].mdlname}" class="small focus autocomplete" placeholder="Middle Name" required/>
									<input type="text" id="autocomplete" name="input.autocompletelastname" value="${sessionScope.lsreg[0].lstname}" class="small focus autocomplete" placeholder="Last Name" required/>
							...
							<div class="field">
								...
								<div class="textarea textarea-editor">
									<textarea id="textarea" value="${sessionScope.lsreg22.address}"name="textareaaddress" cols="50" rows="6" class="editor"></textarea>
								</div>
							</div>
								...
								<div class="field">
									...
									<div class="select">
										...
										<div class="button highlight" style="float: right;">
											<a href="AddCountry.jsp?x=Add Patient.jsp"
								...
								<div class="field">
									...
									<div class="select">
										...
										<div class="button highlight" style="float: right;">
											<a href="AddState.jsp?x=Add Patient.jsp"
												class="ui-button ui-widget ui-state-default ui-corner-all"
												style="font-weight: bold;">Add</a>
										</div>
									</div>
