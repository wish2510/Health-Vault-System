				...
				<div class="box">
					...
					<div class="table">
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td class="left"><a href="<%=request.getContextPath() %>/Notescontroller?id=${row.noteid}&flag=displaynotes"><c:out value="${row.notetype}"></c:out></a></td>
									<td><a href=""><c:out value="${row.note}"></c:out></a></td>
						...
						<div class="buttons" style="float: left; margin-top: 100px; margin-left: 400px;">
								<a class="ui-button ui-widget ui-state-default ui-corner-all" href="User_AddNotes.jsp" >Add</a>
