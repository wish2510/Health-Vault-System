						...
						<div class="search">
							...
							<input type="hidden" value="search" name="flag" />
								<div class="input">
									...
									<input  type="text" id="search" name="searchbypatient" />
								</div>
								<div class="button">
									<input class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false" type="submit" name="submit" value="Search" />
								</div>
							</form>
						</div>
					</div>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td class="left"><c:out value="${row[0].fstname} "></c:out></td>
									<td><c:out value="${row[0].username} "></c:out></td>
									<td><c:out value="${row[0].regtype} "></c:out></td>
									<td><c:out value="${row[1].emailprimary}"></c:out></td>
