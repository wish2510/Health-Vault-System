...
jQuery(window).load(function(){
	...
	if( personnal_item.length > 0 ){
		var personnal_nav = personnal_item.siblings('.personnal-navigation');
		gdl_cycle_resize(personnal_item);
		personnal_item.cycle({ fx: 'fade', slideResize: 1, fit: true, width: '100%',
